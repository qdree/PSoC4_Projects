...
module top ;
	...
	cy_psoc3_pins_v1_10
		...
		KBD_ROWPins
		 (.oe(tmpOE__KBD_ROWPins_net),
		  .y({4'b0}),
		  .fb({Net_108, Net_107, Net_106, Net_105}),
    ...
    defparam Debounce_Timer.Resolution = 16;
