...
module CharLCD_v2_20_0 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("b3bf49e8-2eb0-4190-bead-9c07c67e31b2/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("dfa3810e-7898-4e26-be75-9e75ae97eaf0"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__noise_buzzer_net;
	wire [0:0] tmpFB_0__noise_buzzer_net;
	wire [0:0] tmpIO_0__noise_buzzer_net;
	wire [0:0] tmpINTERRUPT_0__noise_buzzer_net;
	electrical [0:0] tmpSIOVREF__noise_buzzer_net;

	cy_psoc3_pins_v1_10
		#(.id("e0bd13c8-b51c-42b1-80de-58596515d5e4"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		noise_buzzer
		 (.oe(tmpOE__noise_buzzer_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__noise_buzzer_net[0:0]}),
		  .io({tmpIO_0__noise_buzzer_net[0:0]}),
		  .siovref(tmpSIOVREF__noise_buzzer_net),
		  .interrupt({tmpINTERRUPT_0__noise_buzzer_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__noise_buzzer_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("0b84e3cd-d664-4a08-985f-cf9894617ec7"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
