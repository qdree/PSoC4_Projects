// ======================================================================
// pir_sensor.v generated from TopDesign.cysch
// 04/25/2016 at 22:56
...
module top ;
	...
	wire [0:0] tmpOE__pir_net;
	wire [0:0] tmpFB_0__pir_net;
	wire [0:0] tmpIO_0__pir_net;
	wire [0:0] tmpINTERRUPT_0__pir_net;
	electrical [0:0] tmpSIOVREF__pir_net;
	...
	cy_psoc3_pins_v1_10
		...
		pir
		 (.oe(tmpOE__pir_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__pir_net[0:0]}),
		  .io({tmpIO_0__pir_net[0:0]}),
		  .siovref(tmpSIOVREF__pir_net),
		  .interrupt({tmpINTERRUPT_0__pir_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__pir_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
