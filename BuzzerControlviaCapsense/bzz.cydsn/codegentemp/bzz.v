// ======================================================================
// bzz.v generated from TopDesign.cysch
// 02/07/2016 at 15:27
...
module CharLCD_v2_20_0 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("da03cbb6-f387-46fe-87cd-88e60c9b10d0/ed092b9b-d398-4703-be89-cebf998501f6"),
...
// IDAC_P4_v1_10(IDACRange=0, IDACValue=16, Polarity=1, Resolution=8, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=IDAC_P4_v1_10, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=CapSense:IDAC1, CY_INSTANCE_SHORT_NAME=IDAC1, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=10, CY_REMOVE=false, CY_SUPPRESS_API_GEN=true, CY_VERSION=PSoC Creator  3.3 SP1, INSTANCE_NAME=CapSense_IDAC1, )
...
module CapSense_CSD_P4_v2_40_3 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("da4c39ac-2083-4d98-9c65-6bc3ef5b0d97/899719c0-e797-4403-a44f-07a66de2cbeb"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("da4c39ac-2083-4d98-9c65-6bc3ef5b0d97/73b612cd-240c-4d8e-8340-ea28aabf4b11"),
...
module top ;
	...
	wire [0:0] tmpOE__BZZ_net;
	wire [0:0] tmpFB_0__BZZ_net;
	wire [0:0] tmpIO_0__BZZ_net;
	wire [0:0] tmpINTERRUPT_0__BZZ_net;
	electrical [0:0] tmpSIOVREF__BZZ_net;
	...
	cy_psoc3_pins_v1_10
		...
		BZZ
		 (.oe(tmpOE__BZZ_net),
		  .y({Net_661}),
		  .fb({tmpFB_0__BZZ_net[0:0]}),
		  .io({tmpIO_0__BZZ_net[0:0]}),
		  .siovref(tmpSIOVREF__BZZ_net),
		  .interrupt({tmpINTERRUPT_0__BZZ_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__BZZ_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("629e6b4b-375c-4a54-99c1-42645aea1048"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
