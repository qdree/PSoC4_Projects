...
}CapSense_CONFIG_TYPE_POINTERS_P4_v2_40;
...
typedef struct
{
    ...
    CapSense_CONFIG_TYPE_POINTERS_P4_v2_40 const * pointers;
}CapSense_CONFIG_TYPE_P4_v2_40;
...
void TunePrescalers_P4_v2_40(void *config);
void TuneSensitivity_P4_v2_40(void *config);
void MeasureNoiseEnvelope_P4_v2_40(void *config, const uint8 sensorNumber, const uint16 *rawData);
void CalculateThresholds_P4_v2_40(void *config, const uint8 sensorNumber, const uint8 widget, uint8 *fingerThres, uint8 *noiseThres);
void CalibrateSensors_P4_v2_40(void *config, uint16 rawLevel);
void CalibrateOneDAC_P4_v2_40(void *config, uint16 rawLevel, uint32 curSensor, uint8 *idacLevelsTbl);
