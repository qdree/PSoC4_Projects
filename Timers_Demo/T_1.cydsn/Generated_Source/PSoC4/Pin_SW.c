...
#define SetP4PinDriveMode(shift, mode)  \
    do { \
        Pin_SW_PC =   (Pin_SW_PC & \
                                (uint32)(~(uint32)(Pin_SW_DRIVE_MODE_IND_MASK << (Pin_SW_DRIVE_MODE_BITS * (shift))))) | \
                                (uint32)((uint32)(mode) << (Pin_SW_DRIVE_MODE_BITS * (shift))); \
    } while (0)
...
*
*  Pin_SW_DM_STRONG     Strong Drive 
*  Pin_SW_DM_OD_HI      Open Drain, Drives High 
*  Pin_SW_DM_OD_LO      Open Drain, Drives Low 
*  Pin_SW_DM_RES_UP     Resistive Pull Up 
*  Pin_SW_DM_RES_DWN    Resistive Pull Down 
*  Pin_SW_DM_RES_UPDWN  Resistive Pull Up/Down 
*  Pin_SW_DM_DIG_HIZ    High Impedance Digital 
*  Pin_SW_DM_ALG_HIZ    High Impedance Analog 
*
* Return: 
*  None
*
...
{
	SetP4PinDriveMode(Pin_SW__0__SHIFT, mode);
}
...
*  
* Note:
*  Macro Pin_SW_ReadPS calls this function. 
*  
*******************************************************************************/
