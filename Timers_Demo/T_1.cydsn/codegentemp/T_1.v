// ======================================================================
// T_1.v generated from TopDesign.cysch
// 02/07/2016 at 15:13
...
module top ;
    ...
    Timer_v2_70_0 Timer_Green (
        .reset(Net_2502),
        .interrupt(Net_2497),
        .enable(1'b1),
        .trigger(1'b1),
        .capture(1'b0),
        .capture_out(Net_2501),
        .tc(Net_450),
        .clock(Net_10));
    defparam Timer_Green.CaptureCount = 2;
    defparam Timer_Green.CaptureCounterEnabled = 0;
    defparam Timer_Green.DeviceFamily = "PSoC4";
    defparam Timer_Green.InterruptOnCapture = 0;
    defparam Timer_Green.InterruptOnTC = 0;
    defparam Timer_Green.Resolution = 32;
    defparam Timer_Green.SiliconRevision = "17";
