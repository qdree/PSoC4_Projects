...
module top ;
	...
	wire [0:0] tmpOE__PIR_4_net;
	wire [0:0] tmpFB_0__PIR_4_net;
	wire [0:0] tmpIO_0__PIR_4_net;
	wire [0:0] tmpINTERRUPT_0__PIR_4_net;
	electrical [0:0] tmpSIOVREF__PIR_4_net;
	...
	cy_psoc3_pins_v1_10
		...
		PIR_4
		 (.oe(tmpOE__PIR_4_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PIR_4_net[0:0]}),
		  .io({tmpIO_0__PIR_4_net[0:0]}),
		  .siovref(tmpSIOVREF__PIR_4_net),
		  .interrupt({tmpINTERRUPT_0__PIR_4_net[0:0]}),
		  .annotation({Net_206}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__PIR_4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__PIR_1_net;
	wire [0:0] tmpFB_0__PIR_1_net;
	wire [0:0] tmpIO_0__PIR_1_net;
	wire [0:0] tmpINTERRUPT_0__PIR_1_net;
	electrical [0:0] tmpSIOVREF__PIR_1_net;
	...
	cy_psoc3_pins_v1_10
		...
		PIR_1
		 (.oe(tmpOE__PIR_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PIR_1_net[0:0]}),
		  .io({tmpIO_0__PIR_1_net[0:0]}),
		  .siovref(tmpSIOVREF__PIR_1_net),
		  .interrupt({tmpINTERRUPT_0__PIR_1_net[0:0]}),
		  .annotation({Net_206}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__PIR_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PIR_2_net;
	wire [0:0] tmpFB_0__PIR_2_net;
	wire [0:0] tmpIO_0__PIR_2_net;
	wire [0:0] tmpINTERRUPT_0__PIR_2_net;
	electrical [0:0] tmpSIOVREF__PIR_2_net;
	...
	cy_psoc3_pins_v1_10
		...
		PIR_2
		 (.oe(tmpOE__PIR_2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PIR_2_net[0:0]}),
		  .io({tmpIO_0__PIR_2_net[0:0]}),
		  .siovref(tmpSIOVREF__PIR_2_net),
		  .interrupt({tmpINTERRUPT_0__PIR_2_net[0:0]}),
		  .annotation({Net_206}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__PIR_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PIR_3_net;
	wire [0:0] tmpFB_0__PIR_3_net;
	wire [0:0] tmpIO_0__PIR_3_net;
	wire [0:0] tmpINTERRUPT_0__PIR_3_net;
	electrical [0:0] tmpSIOVREF__PIR_3_net;
	...
	cy_psoc3_pins_v1_10
		...
		PIR_3
		 (.oe(tmpOE__PIR_3_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PIR_3_net[0:0]}),
		  .io({tmpIO_0__PIR_3_net[0:0]}),
		  .siovref(tmpSIOVREF__PIR_3_net),
		  .interrupt({tmpINTERRUPT_0__PIR_3_net[0:0]}),
		  .annotation({Net_206}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__PIR_3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
