// ======================================================================
// Security_system.v generated from TopDesign.cysch
// 06/10/2016 at 14:45
...
module top ;
	...
	cy_psoc3_pins_v1_10
		...
		KBD_ROWPins
		 (.oe(tmpOE__KBD_ROWPins_net),
		  .y({4'b0}),
		  .fb({Net_104, Net_103, Net_102, Net_101}),
	...
	wire [2:0] tmpOE__KBD_COLPins_net;
	wire [2:0] tmpIO_2__KBD_COLPins_net;
	...
	cy_psoc3_pins_v1_10
		...
		KBD_COLPins
		 (.oe(tmpOE__KBD_COLPins_net),
		  .y({3'b0}),
		  .fb({Net_99, Net_98, Net_97}),
		  .io({tmpIO_2__KBD_COLPins_net[2:0]}),
	...
	assign tmpOE__KBD_COLPins_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{3'b111} : {3'b111};

	wire [0:0] tmpOE__Kitchen_PIR_net;
	wire [0:0] tmpFB_0__Kitchen_PIR_net;
	wire [0:0] tmpIO_0__Kitchen_PIR_net;
	wire [0:0] tmpINTERRUPT_0__Kitchen_PIR_net;
	electrical [0:0] tmpSIOVREF__Kitchen_PIR_net;

	cy_psoc3_pins_v1_10
		#(.id("7301d793-ad6a-4de1-88bf-695e9f12f480"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Kitchen_PIR
		 (.oe(tmpOE__Kitchen_PIR_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Kitchen_PIR_net[0:0]}),
		  .io({tmpIO_0__Kitchen_PIR_net[0:0]}),
		  .siovref(tmpSIOVREF__Kitchen_PIR_net),
		  .interrupt({tmpINTERRUPT_0__Kitchen_PIR_net[0:0]}),
		  .annotation({Net_242}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Kitchen_PIR_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("a2aa916c-03d2-49e0-9989-b65026239056"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("5c2acc71-4af5-4b0b-83bc-409d02dc61fd"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("d6c1e60a-6279-4a94-83be-e8512cf1bb2e"),
		  .source_clock_id("413DE2EF-D9F2-4233-A808-DFAF137FD877"),
		  .divisor(0),
		  .period("0"),
		  .is_direct(1),
    ...
    Timer_v2_70_3 Alarm_Timer (
        ...
        .tc(Net_29),
        .clock(Net_138));
    defparam Alarm_Timer.CaptureCount = 2;
    defparam Alarm_Timer.CaptureCounterEnabled = 0;
    defparam Alarm_Timer.DeviceFamily = "PSoC4";
    defparam Alarm_Timer.InterruptOnCapture = 0;
    defparam Alarm_Timer.InterruptOnTC = 0;
    defparam Alarm_Timer.Resolution = 8;
    defparam Alarm_Timer.SiliconRevision = "17";
	...
	cy_psoc3_pins_v1_10
		#(.id("f2f65361-a62f-4970-868a-cbf66cf274ec"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Hall_PIR_net;
	wire [0:0] tmpFB_0__Hall_PIR_net;
	wire [0:0] tmpIO_0__Hall_PIR_net;
	wire [0:0] tmpINTERRUPT_0__Hall_PIR_net;
	electrical [0:0] tmpSIOVREF__Hall_PIR_net;

	cy_psoc3_pins_v1_10
		#(.id("4ca23d19-8a9b-474b-85e8-fe330d163b00"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Hall_PIR
		 (.oe(tmpOE__Hall_PIR_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Hall_PIR_net[0:0]}),
		  .io({tmpIO_0__Hall_PIR_net[0:0]}),
		  .siovref(tmpSIOVREF__Hall_PIR_net),
		  .interrupt({tmpINTERRUPT_0__Hall_PIR_net[0:0]}),
		  .annotation({Net_345}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Hall_PIR_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Bedroom_PIR_net;
	wire [0:0] tmpFB_0__Bedroom_PIR_net;
	wire [0:0] tmpIO_0__Bedroom_PIR_net;
	wire [0:0] tmpINTERRUPT_0__Bedroom_PIR_net;
	electrical [0:0] tmpSIOVREF__Bedroom_PIR_net;

	cy_psoc3_pins_v1_10
		#(.id("d7794ed1-be5c-4251-a8f9-3ead5ec512a1"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Bedroom_PIR
		 (.oe(tmpOE__Bedroom_PIR_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Bedroom_PIR_net[0:0]}),
		  .io({tmpIO_0__Bedroom_PIR_net[0:0]}),
		  .siovref(tmpSIOVREF__Bedroom_PIR_net),
		  .interrupt({tmpINTERRUPT_0__Bedroom_PIR_net[0:0]}),
		  .annotation({Net_343}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Bedroom_PIR_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Guestroom_PIR_net;
	wire [0:0] tmpFB_0__Guestroom_PIR_net;
	wire [0:0] tmpIO_0__Guestroom_PIR_net;
	wire [0:0] tmpINTERRUPT_0__Guestroom_PIR_net;
	electrical [0:0] tmpSIOVREF__Guestroom_PIR_net;

	cy_psoc3_pins_v1_10
		#(.id("4e28abf6-452b-4a25-903b-7d7cac5c23f9"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Guestroom_PIR
		 (.oe(tmpOE__Guestroom_PIR_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Guestroom_PIR_net[0:0]}),
		  .io({tmpIO_0__Guestroom_PIR_net[0:0]}),
		  .siovref(tmpSIOVREF__Guestroom_PIR_net),
		  .interrupt({tmpINTERRUPT_0__Guestroom_PIR_net[0:0]}),
		  .annotation({Net_240}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Guestroom_PIR_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Front_door_net;
	wire [0:0] tmpFB_0__Front_door_net;
	wire [0:0] tmpIO_0__Front_door_net;
	wire [0:0] tmpINTERRUPT_0__Front_door_net;
	electrical [0:0] tmpSIOVREF__Front_door_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		Front_door
		 (.oe(tmpOE__Front_door_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Front_door_net[0:0]}),
		  .io({tmpIO_0__Front_door_net[0:0]}),
		  .siovref(tmpSIOVREF__Front_door_net),
		  .interrupt({tmpINTERRUPT_0__Front_door_net[0:0]}),
		  .annotation({Net_179}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Front_door_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Back_door_net;
	wire [0:0] tmpFB_0__Back_door_net;
	wire [0:0] tmpIO_0__Back_door_net;
	wire [0:0] tmpINTERRUPT_0__Back_door_net;
	electrical [0:0] tmpSIOVREF__Back_door_net;

	cy_psoc3_pins_v1_10
		#(.id("535aa595-023e-4187-ba5f-a45bc62da07b"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Back_door
		 (.oe(tmpOE__Back_door_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Back_door_net[0:0]}),
		  .io({tmpIO_0__Back_door_net[0:0]}),
		  .siovref(tmpSIOVREF__Back_door_net),
		  .interrupt({tmpINTERRUPT_0__Back_door_net[0:0]}),
		  .annotation({Net_183}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Back_door_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
