...
#define KBD_COLPins_3		(KBD_COLPins__3__PC)
#define KBD_COLPins_3_PS		(KBD_COLPins__3__PS)
#define KBD_COLPins_3_PC		(KBD_COLPins__3__PC)
#define KBD_COLPins_3_DR		(KBD_COLPins__3__DR)
#define KBD_COLPins_3_SHIFT	(KBD_COLPins__3__SHIFT)
